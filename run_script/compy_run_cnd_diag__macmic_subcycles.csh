...
# Fetch code
####################################################################
setenv CODE_ROOT ~/codes/
setenv CCSM_TAG  CondiDiag_for_MichaelBrunke
setenv CCSM_ROOT ${CODE_ROOT}/${CCSM_TAG}

setenv BRANCH zhan391/atm/e3sm_cond_diag_ec03cdd285 
...
setenv CASE_NAME        macmic_subcycles_${MACH}_${COMPSET}_${RESOLUTION}_${CCSM_TAG}
setenv PTMP             /compyfs/$user/scidac_scratch
