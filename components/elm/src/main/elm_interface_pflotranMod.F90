...
#ifdef ELM_PFLOTRAN
  !use elm_pflotran_interface_data ! due to pflotran version, either 'elm_pflotran_interface_data' or 'elmpf_interface_data' like below
...
!
  ...
  subroutine interface_init(bounds)
    ...
    use elm_time_manager, only : get_nstep, get_step_size, calc_nestep, nestep
    ...
    ! coupled module controls betweeen PFLOTRAN and ELM45
