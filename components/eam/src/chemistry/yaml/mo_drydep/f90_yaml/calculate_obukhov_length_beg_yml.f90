  ...
  !-----------------------------------------------------------------------------------------
     ...
     !if ((n_calls==1 .and. flag==0) .or. (n_calls==3 .and. flag==1) .or. (n_calls==5 .and. flag==2)) then
        ...
        call open_files('calculate_obukhov_length', &  !intent-in
        ...
        call write_input_output_header(unit_input, unit_output,yaml%lchnk_print,yaml%col_print, &
             'calculate_obukhov_length',yaml%nstep_print, yaml%lev_print)
        ...
        call write_var(unit_input,unit_output,'unstable',unstable(yaml%col_print))
        call write_var(unit_input,unit_output,'tha',tha(yaml%col_print))
        call write_var(unit_input,unit_output,'thg',thg(yaml%col_print))
        ...
        call write_var(unit_input,unit_output,'va',va(yaml%col_print))
        call write_var(unit_input,unit_output,'bycp',bycp(yaml%col_print,:))
