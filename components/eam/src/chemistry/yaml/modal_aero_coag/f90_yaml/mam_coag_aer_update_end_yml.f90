  ...
  if(yaml%flag_print) then ! if this column exists in lchnk
     ...
     call write_2d_output_var(unit_output, 'qaer_end',max_aer,max_mode, qaer_end)
     call write_2d_output_var(unit_output, 'qaer_del_coag_out',max_aer,max_agepair, qaer_del_coag_out)
