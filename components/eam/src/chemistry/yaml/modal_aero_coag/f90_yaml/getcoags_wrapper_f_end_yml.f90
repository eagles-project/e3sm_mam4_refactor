  ...
  if(yaml%flag_print) then ! if this column exists in lchnk
     ...
     call write_output_var(unit_output, 'betaij0', betaij0)
     call write_output_var(unit_output, 'betaii0', betaii0)
     call write_output_var(unit_output, 'betajj0', betajj0)
     call write_output_var(unit_output, 'betaij3', betaij3)
