  ...
  if(yaml%flag_print) then ! if this column exists in lchnk
     ...
     call write_output_var(unit_output, 'qn11', qn11)
     call write_output_var(unit_output, 'qn22', qn22)
     call write_output_var(unit_output, 'qn12', qn12)
     call write_output_var(unit_output, 'qv12', qv12)
