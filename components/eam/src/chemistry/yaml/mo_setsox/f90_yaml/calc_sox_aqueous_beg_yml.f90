  ...
  yaml%lev_print = 47       !level with delta_s<xso2
!  yaml%lev_print = 37       !level with delta_s>xso2
  ...
  !-----------------------------------------------------------------------------------------
     ...
     !if ((n_calls==1 .and. flag==0) .or. (n_calls==3 .and. flag==1) .or. (n_calls==5 .and. flag==2)) then
        ...
        call open_files('calc_sox_aqueous', &  !intent-in
        ...
        call write_input_output_header(unit_input, unit_output,yaml%lchnk_print,yaml%col_print, &
             'calc_sox_aqueous',yaml%nstep_print, yaml%lev_print)

        ! add code for writing data here
        
        call write_var(unit_input,unit_output,'modal_aerosols',modal_aerosols)
        call write_var(unit_input,unit_output,'rah2o2',rah2o2)
        call write_var(unit_input,unit_output,'h2o2g',h2o2g)
        call write_var(unit_input,unit_output,'so2g',so2g)
        call write_var(unit_input,unit_output,'o3g',o3g)
        call write_var(unit_input,unit_output,'rao3',rao3)
        call write_var(unit_input,unit_output,'patm',patm)
        call write_var(unit_input,unit_output,'dtime',dtime)
        call write_var(unit_input,unit_output,'t_factor',t_factor)
        call write_var(unit_input,unit_output,'xlwc',xlwc)
        call write_var(unit_input,unit_output,'const0',const0)
        call write_var(unit_input,unit_output,'xhnm',xhnm)
        call write_var(unit_input,unit_output,'heo3',heo3)
        call write_var(unit_input,unit_output,'heso2',heso2)
        call write_var(unit_input,unit_output,'xso2',xso2)
        call write_var(unit_input,unit_output,'xso4',xso4)
        call write_var(unit_input,unit_output,'xso4_init',xso4_init)
        call write_var(unit_input,unit_output,'xh2o2',xh2o2)
