  ...
  !-----------------------------------------------------------------------------------------
     ...
     !if ((n_calls==1 .and. flag==0) .or. (n_calls==3 .and. flag==1) .or. (n_calls==5 .and. flag==2)) then
        ...
        call open_files('mam_newnuc_1subarea', &  !intent-in
        ...
        call write_input_output_header(unit_input, unit_output,yaml%lchnk_print,yaml%col_print, &
             'mam_newnuc_1subarea',yaml%nstep_print, yaml%lev_print)
        ...
        call write_var(unit_input,unit_output,'del_h2so4_gasprod',del_h2so4_gasprod)
        call write_var(unit_input,unit_output,'del_h2so4_aeruptk',del_h2so4_aeruptk)
        ...
        call write_var(unit_input,unit_output,'dnclusterdt',dnclusterdt)
...
! below are external module inputs to mam_newnuc_1subarea
        ...
        call write_var(unit_input,unit_output,'iaer_so4',iaer_so4)      
        call write_var(unit_input,unit_output,'iaer_nh4',iaer_nh4)      
        ...
        call write_var(unit_input,unit_output,'dgnum_aer',dgnum_aer(nait))
        call write_var(unit_input,unit_output,'dgnumlo_aer',dgnumlo_aer(nait))
        call write_var(unit_input,unit_output,'dgnumhi_aer',dgnumhi_aer(nait))
        call write_var(unit_input,unit_output,'gaexch_h2so4_uptake_optaa',gaexch_h2so4_uptake_optaa)      
        call write_var(unit_input,unit_output,'newnuc_h2so4_conc_optaa',newnuc_h2so4_conc_optaa)      
        call write_var(unit_input,unit_output,'dens_so4a_host',dens_so4a_host)      
        call write_var(unit_input,unit_output,'mwso4a_host',mw_so4a_host)      
        call write_var(unit_input,unit_output,'newnuc_adjust_factor_dnaitdt',newnuc_adjust_factor_dnaitdt)      
        call write_var(unit_input,unit_output,'mw_nh4a_host',mw_nh4a_host)      
        call write_var(unit_input,unit_output,'qh2so4_cutoff',qh2so4_cutoff)      
