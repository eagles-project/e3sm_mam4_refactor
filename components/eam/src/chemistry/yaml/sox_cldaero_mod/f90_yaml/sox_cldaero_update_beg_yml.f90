...
!  if(yaml%col_print == y_i .and. y_nstep==yaml%nstep_print .and. y_k == yaml%lev_print) then ! if this column exists in y_lchnk
  ...
  !-----------------------------------------------------------------------------------------
     ...
     !if ((n_calls==1 .and. flag==0) .or. (n_calls==3 .and. flag==1) .or. (n_calls==5 .and. flag==2)) then
        ...
        call open_files('sox_cldaero_update', &  !intent-in
        ...
        call write_input_output_header(unit_input, unit_output,yaml%lchnk_print,yaml%col_print, &
             'sox_cldaero_update',yaml%nstep_print, yaml%lev_print)
        ...
        call write_var(unit_input,unit_output,'press',press(yaml%col_print,yaml%lev_print))
        call write_var(unit_input,unit_output,'tfld',tfld(yaml%col_print,yaml%lev_print))
        call write_var(unit_input,unit_output,'cldnum',cldnum(yaml%col_print,yaml%lev_print))
        call write_var(unit_input,unit_output,'cldfrc',cldfrc(yaml%col_print,yaml%lev_print))
        call write_var(unit_input,unit_output,'cfact',cfact(yaml%col_print,yaml%lev_print))
        call write_var(unit_input,unit_output,'xlwc',xlwc(yaml%col_print,yaml%lev_print))
        call write_var(unit_input,unit_output,'delso4_hprxn',delso4_hprxn(yaml%col_print,yaml%lev_print))
        call write_var(unit_input,unit_output,'xh2so4',xh2so4(yaml%col_print,yaml%lev_print))
        call write_var(unit_input,unit_output,'xso4',xso4(yaml%col_print,yaml%lev_print))
        call write_var(unit_input,unit_output,'xso4_init',xso4_init(yaml%col_print,yaml%lev_print))
        call write_var(unit_input,unit_output,'qcw',qcw(yaml%col_print,yaml%lev_print,:))
        call write_var(unit_input,unit_output,'qin',qin(yaml%col_print,yaml%lev_print,:))
