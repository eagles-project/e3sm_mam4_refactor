  ...
  !-----------------------------------------------------------------------------------------
     ...
     !if ((n_calls==1 .and. flag==0) .or. (n_calls==3 .and. flag==1) .or. (n_calls==5 .and. flag==2)) then
        ...
        call open_files('compute_odap_volcanic_above_troplayer_lw', &  !intent-in
        ...
        call write_input_output_header(unit_input, unit_output,yaml%lchnk_print,yaml%col_print, &
             'compute_odap_volcanic_above_troplayer_lw',yaml%nstep_print, yaml%lev_print)
        ...
        call write_var(unit_input,unit_output,'ext_cmip6_lw_inv_m',ext_cmip6_lw_inv_m(yaml%col_print,:,:))
        call write_var(unit_input,unit_output,'odap_aer',odap_aer(yaml%col_print,:,:))
