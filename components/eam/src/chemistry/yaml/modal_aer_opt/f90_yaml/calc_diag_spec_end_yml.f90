  ...
  if(yaml%flag_print) then ! if this column exists in lchnk
     ...
     !start writing data
        ...
        call write_var(unit_output,'burden_s',burden_s(yaml%col_print))
        call write_var(unit_output,'scat_s',scat_s(yaml%col_print))
        call write_var(unit_output,'abs_s',abs_s(yaml%col_print))
        call write_var(unit_output,'hygro_s',hygro_s(yaml%col_print))
