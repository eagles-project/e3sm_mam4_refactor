  ...
  if(yaml%flag_print) then ! if this column exists in lchnk
     ...
     !start writing data
        ...
        call write_var(unit_output,'dqdt_tmp',dqdt_tmp(yaml%col_print,yaml%lev_print))
        call write_var(unit_output,'rtscavt_sv',rtscavt_sv(yaml%col_print,yaml%lev_print,:))
