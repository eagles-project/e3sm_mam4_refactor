  ...
  if(yaml%flag_print) then ! if this column exists in lchnk
     ...
     !start writing data
        ...
        call write_var(unit_output,'mm',mm)
        call write_var(unit_output,'jnv',jnv)
        call write_var(unit_output,'jnummaswtr',jnummaswtr)
...
!      write(103,*) 'n_calls = ',n_calls, mm, jnv, jnummaswtr
!endif
!------------------------------------------------------------------------------------------------------------------------------
