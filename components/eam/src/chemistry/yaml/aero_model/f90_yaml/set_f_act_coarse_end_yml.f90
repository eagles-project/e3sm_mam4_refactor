  ...
  if(yaml%flag_print) then ! if this column exists in lchnk
     ...
     !start writing data
        ...
        call write_var(unit_output,'f_act_conv_coarse',f_act_conv_coarse(yaml%col_print,yaml%lev_print))
        call write_var(unit_output,'f_act_conv_coarse_dust',f_act_conv_coarse_dust)
        call write_var(unit_output,'f_act_conv_coarse_nacl',f_act_conv_coarse_nacl)
