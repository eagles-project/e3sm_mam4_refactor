  ...
  if(yaml%flag_print) then ! if this column exists in lchnk
     ...
     call write_output_var(unit_output, 'cldv', cldv(yaml%col_print,yaml%lev_print))
     call write_output_var(unit_output, 'cldvcu',cldvcu(yaml%col_print,yaml%lev_print))
     call write_output_var(unit_output, 'cldvst',cldvst(yaml%col_print,yaml%lev_print))
