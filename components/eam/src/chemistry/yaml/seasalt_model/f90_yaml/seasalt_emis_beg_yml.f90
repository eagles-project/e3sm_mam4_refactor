  ...
  !-----------------------------------------------------------------------------------------
     ...
     !if ((n_calls==1 .and. flag==0) .or. (n_calls==3 .and. flag==1) .or. (n_calls==5 .and. flag==2)) then
        ...
        call open_files('seasalt_emis', &  !intent-in
        ...
        call write_input_output_header(unit_input, unit_output,yaml%lchnk_print,yaml%col_print, &
             'seasalt_emis',yaml%nstep_print, yaml%lev_print)
        ...
        call write_var(unit_input,unit_output,'num_flx_flag',num_flx_flag)
        call write_var(unit_input,unit_output,'mass_flx_flag',mass_flx_flag)        
