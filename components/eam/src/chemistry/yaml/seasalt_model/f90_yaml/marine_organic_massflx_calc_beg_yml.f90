  ...
  !-----------------------------------------------------------------------------------------
     ...
     !if ((n_calls==1 .and. flag==0) .or. (n_calls==3 .and. flag==1) .or. (n_calls==5 .and. flag==2)) then
        ...
        call open_files('marine_organic_massflx_calc', &  !intent-in
        ...
        call write_input_output_header(unit_input, unit_output,yaml%lchnk_print,yaml%col_print, &
             'marine_organic_massflx_calc',yaml%nstep_print, yaml%lev_print)
        ...
        call write_var(unit_input,unit_output,'mass_frac_bub_section',mass_frac_bub_section(yaml%col_print,:,:))
