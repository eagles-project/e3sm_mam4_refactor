...
!!!!!!  yaml%nstep_print = 55 !time step
  ...
  !-----------------------------------------------------------------------------------------
     ...
     !if ((n_calls==1 .and. flag==0) .or. (n_calls==3 .and. flag==1) .or. (n_calls==5 .and. flag==2)) then
        ...
        call open_files('get_gcm_tend_diags_from_subareas', &  !intent-in
        ...
        call write_input_output_header(unit_input, unit_output,yaml%lchnk_print,yaml%col_print, &
             'get_gcm_tend_diags_from_subareas',yaml%nstep_print, yaml%lev_print)
        ...
        ! below are external module inputs to get_gcm_tend_diags_from_subareas
