...
!             unit_input, unit_output, trim(ext_str)) !intent-out, with the use of ext_str
        ...
        call write_1d_var(unit_input, unit_output, 'wetvol',nmodes, wetvol(yaml%col_print, yaml%lev_print, :))
        call write_1d_var(unit_input, unit_output, 'wtrvol',nmodes, wtrvol(yaml%col_print,yaml%lev_print, :))
        call write_1d_var(unit_input, unit_output, 'drymass',nmodes, drymass(yaml%col_print,yaml%lev_print, :))
        call write_1d_var(unit_input, unit_output, 'specdens_1',nmodes, specdens_1)
        call write_1d_var(unit_input, unit_output, 'wetdens',nmodes, wetdens(yaml%col_print,yaml%lev_print, :))
