  ...
  !-----------------------------------------------------------------------------------------
     ...
     !if ((n_calls==1 .and. flag==0) .or. (n_calls==3 .and. flag==1) .or. (n_calls==5 .and. flag==2)) then
        ...
        call open_files('set_subarea_gases_and_aerosols', &  !intent-in
        ...
        call write_input_output_header(unit_input, unit_output,yaml%lchnk_print,yaml%col_print, &
             'set_subarea_gases_and_aerosols',yaml%nstep_print, yaml%lev_print)
        ...
        call write_var(unit_input,unit_output,'qgcm1',qgcm1(:))
        call write_var(unit_input,unit_output,'qgcm2',qgcm2(:))
        call write_var(unit_input,unit_output,'qqcwgcm2',qqcwgcm2(:))
        call write_var(unit_input,unit_output,'qgcm3',qgcm3(:))
        call write_var(unit_input,unit_output,'qqcwgcm3',qqcwgcm3(:))

        ! below are external module inputs to set_subarea_gases_and_aerosols
