  ...
  !-----------------------------------------------------------------------------------------
     ...
     !if ((n_calls==1 .and. flag==0) .or. (n_calls==3 .and. flag==1) .or. (n_calls==5 .and. flag==2)) then
        ...
        call open_files('form_gcm_of_gases_and_aerosols_from_subareas', &  !intent-in
        ...
        call write_input_output_header(unit_input, unit_output,yaml%lchnk_print,yaml%col_print, &
             'form_gcm_of_gases_and_aerosols_from_subareas',yaml%nstep_print, yaml%lev_print)
        ...
        call write_var(unit_input,unit_output,'qsub',qsub(:,:))
        call write_var(unit_input,unit_output,'qqcwsub',qqcwsub(:,:))
        call write_var(unit_input,unit_output,'qqcwgcm_old',qqcwgcm_old(:))

        ! below are external module inputs to form_gcm_of_gases_and_aerosols_from_subareas
