  ...
  !-----------------------------------------------------------------------------------------
     ...
     !if ((n_calls==1 .and. flag==0) .or. (n_calls==3 .and. flag==1) .or. (n_calls==5 .and. flag==2)) then
        ...
        call open_files('set_subarea_rh', &  !intent-in
        ...
        call write_input_output_header(unit_input, unit_output,yaml%lchnk_print,yaml%col_print, &
             'set_subarea_rh',yaml%nstep_print, yaml%lev_print)
        ...
        call write_var(unit_input,unit_output,'relhumgcm',relhumgcm)

        ! below are external module inputs to set_subarea_rh
