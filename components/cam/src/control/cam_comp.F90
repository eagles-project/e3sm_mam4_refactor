...
!-----------------------------------------------------------------------
   ...
   !
   !----------------------------------------------------------
   ! Call dynamics concurrently with physics if PS  AaronDonahue
   !----------------------------------------------------------
   !
   if (ftype.eq.30) then !AaronDonahue
...
!-----------------------------------------------------------------------
   ...
   if (ftype.ne.30) then !AaronDonahue
   !
...
!-----------------------------------------------------------------------
   ...
   ! Finish any physics/dynamics state updates if needed. 
   call t_barrierf ('sync_stepon_run4', mpicom)
   call t_startf ('stepon_run4')
   call stepon_run4( dtime, cam_out, phys_state, dyn_in, dyn_out, phys_tend )
