...
!========================================================
!subroutine get_values_from_state( arrayout, varname, state, pbuf, cam_in, cam_out )
subroutine get_values_from_state( arrayout, varname, state)
...
end subroutine get_values_from_state
