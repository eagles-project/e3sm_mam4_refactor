...
subroutine phys_register
    ...
    if (moist_physics) then
       ...
       ! Save the relevant prognostic variables in pbuf for the tendency
       ! dribbling in cloud physics paramterization 
...
!>songxl 2011-09-20----------------------------
    ...
    !Shixuan Zhang & HuiWan (2020/07): added for a test of using tendency
    !dribbling in cloud physics parameterizations 
