...
integer :: rkz_zsmall_opt    = 0
integer :: rkz_lmt5_opt      = 0
...
subroutine phys_ctl_readnl(nlfile)
   ...
   namelist /phys_ctl_nl/ cam_physpkg, cam_chempkg, waccmx_opt, deep_scheme, shallow_scheme, &
      ...
      rkz_term_C_ql_opt, rkz_term_C_fmin, rkz_zsmall_opt, rkz_lmt5_opt, rkz_ql_f_opt, l_rkz_lmt_2, &
   ...
   call mpibcast(rkz_ql_f_opt,                    1 , mpiint,  0, mpicom)
...
subroutine phys_getopts(deep_scheme_out, shallow_scheme_out, eddy_scheme_out, microp_scheme_out, &
                       ...
                       ,rkz_lmt5_opt_out, rkz_ql_f_opt_out, l_rkz_lmt_2_out, l_rkz_lmt_3_out &
                       ,l_rkz_lmt_4_out, l_rkz_lmt_5_out &
...
!-----------------------------------------------------------------------
   ...
   integer,           intent(out), optional :: rkz_ql_f_opt_out
   ...
   if ( present(rkz_ql_f_opt_out        ) ) rkz_ql_f_opt_out      = rkz_ql_f_opt
