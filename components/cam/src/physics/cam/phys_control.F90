...
subroutine phys_ctl_readnl(nlfile)
   ...
   namelist /phys_ctl_nl/ cam_physpkg, cam_chempkg, waccmx_opt, deep_scheme, shallow_scheme, &
      ...
      conv_water_in_rad, history_clubb, do_clubb_sgs, do_clubb_warmint, do_clubb_outpint, &
   ...
   call mpibcast(do_clubb_warmint,                1 , mpilog,  0, mpicom)
   call mpibcast(do_clubb_outpint,                1 , mpilog,  0, mpicom)   
...
subroutine phys_getopts(deep_scheme_out, shallow_scheme_out, eddy_scheme_out, & 
                        ...
                        do_clubb_sgs_out, do_clubb_warmint_out, do_clubb_outpint_out, &
...
!-----------------------------------------------------------------------
   ...
   logical,           intent(out), optional :: do_clubb_warmint_out
   logical,           intent(out), optional :: do_clubb_outpint_out   
   ...
   if ( present(do_clubb_warmint_out    ) ) do_clubb_warmint_out     = do_clubb_warmint
   if ( present(do_clubb_outpint_out    ) ) do_clubb_outpint_out     = do_clubb_outpint   
